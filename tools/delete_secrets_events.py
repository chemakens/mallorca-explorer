#!/usr/bin/env python3
"""
Delete Secrets Night Events from Firestore
-------------------------------------------
Removes all events from SECRETS MALLORCA venue or with "Secrets Night" in title.
"""
...
print("\n" + "=" * 80)
print("SEARCHING FOR SECRETS MALLORCA EVENTS")
print("=" * 80)
...
try:
    ...
    for doc in all_docs:
        ...
        elif "Secrets Night" in title:
            should_delete = True
            reason = f"title contains 'Secrets Night'"
    ...
    if not events_to_delete:
        print("\n✅ No SECRETS MALLORCA events found. Database is clean!")
        sys.exit(0)
